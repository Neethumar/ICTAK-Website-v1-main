...
const style = {
  wrapper: `bg-[#19282F] w-screen px-[1.2rem] py-[0.8rem] flex justify-between`,
    ...
    return (
        <div className={style.wrapper}>
          ...
          <div className={style.headerItems}>
            ...
            <Link to="https://retail.ictkerala.org" className={style.headerItem}>
              Paatshala
            </Link>
            <Link to="/News" className={style.headerItem}>
              News
            </Link>
            <Link to="/Careers" className={style.headerItem}>
              Careers
            </Link>
